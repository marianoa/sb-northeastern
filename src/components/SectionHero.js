...
export default function SectionHero(props) {
    ...
    return (
        <section id={sectionId} className={`block hero-block outer`} style={{backgroundImage: `url(${backgroundImage}`, backgroundSize: `cover`, backgroundRepeat: `no-repeat`, backgroundPosition:`left`}}>
            <div className="inner">
